...
INSERT INTO Personas.Email (correo, fecha_mod)
VALUES
('contacto@constructoraxa.com', GETDATE()),
...
INSERT INTO Personas.Domicilio (domicilio_linea1, domicilio_linea2, cod_postal, LocalidadId, TipoDomicilioId, fecha_mod)
VALUES
('Av. Insurgentes 2600', 'Residencial Las Palmas', '81650', 1, 1, GETDATE()),
...
VALUES
    ('Atención al Cliente', '192.168.1.0/24', GETDATE()),
...
VALUES
    ('JAPAMA Central', 1, 36, 1, 1, GETDATE()),
...
-- Cajeros Automáticos
INSERT INTO Sucursales.CajeroAutomatico (EstablecimientoId, actividad, fecha_inicio, fecha_cierre, horario, BancoId, fecha_mod)
VALUES
    (1, 'A', '2024-01-01', '2024-12-31', '24/7', 1, GETDATE()),
...
-- Contratos
INSERT INTO RecursosHumanos.ContratoEmpleado (tipo_contrato, fecha_contrato, fecha_vencimiento, enlace_documento, fecha_mod)
VALUES
('SIN', '2024-01-01', '2025-01-01', 'contratos/2024/SIN001.pdf', GETDATE()),
...
VALUES
('Gerente General', 35000.00, 5000.00, GETDATE()),
...
INSERT INTO RecursosHumanos.Empleado (nss, rfc, ContratoId, PuestoId, edo_civil,
    fecha_nacimiento, fecha_contratacion, actividad, fecha_mod, PersonaId, TurnoId, NominaId, EstablecimientoId)
VALUES
('12345678901', 'XAXX010101000', 1, 1, 'CAS', '1980-01-15', '2024-01-01', 'A', GETDATE(), 1, 1, 1, 1),
...
VALUES
(1, '2024-03-01 07:00', '2024-03-01 15:00', GETDATE()),
...
VALUES
('Tubo PVC 4"', 'Tubo PVC hidráulico', 'A', 1, GETDATE()),
...
VALUES
('Escritorio Ejecutivo', 'Escritorio en L con cajones', 'A', 1, GETDATE()),
...
VALUES
(1, 1, 'Mantenimiento preventivo', '2024-03-01', GETDATE()),
...
VALUES
(1, '2024-03-01', 'facturas/2024/FAC001.pdf', GETDATE()),
...
VALUES
(1, 1, 1, '2024-03-01', 5000.00, 50, GETDATE()),
...
VALUES
('Fuga en medidor', '2024-03-01', 1, 'En proceso', 3, 'Prioridad alta', GETDATE()),
...
VALUES
('T', 'Falta de pago 3 meses', '2024-03-01', 'suspensiones/2024/SUS001.pdf', GETDATE()),
...
VALUES
('cartas/2024/CNA001.pdf', GETDATE()),
...
VALUES
('Pensionados IMSS', 50.00, '2024-01-01', '2024-12-31', GETDATE()),
...
(11, 1, NULL, NULL, NULL, GETDATE()),
(12, 2, NULL, NULL, NULL, GETDATE()),
(13, 3, NULL, NULL, NULL, GETDATE()),
(14, 4, NULL, NULL, NULL, GETDATE()),
(15, 5, NULL, NULL, NULL, GETDATE()),
(16, 6, NULL, NULL, NULL, GETDATE()),
(17, 7, NULL, NULL, NULL, GETDATE()),
(18, 8, NULL, NULL, NULL, GETDATE()),
(19, 9, NULL, NULL, NULL, GETDATE()),
(20, 10, NULL, NULL, NULL, GETDATE()),
-- 10 tickets con cartas de no adeudo
(21, NULL, NULL, NULL, 1, GETDATE()),
(22, NULL, NULL, NULL, 2, GETDATE()),
(23, NULL, NULL, NULL, 3, GETDATE()),
(24, NULL, NULL, NULL, 4, GETDATE()),
(25, NULL, NULL, NULL, 5, GETDATE()),
(26, NULL, NULL, NULL, 6, GETDATE()),
(27, NULL, NULL, NULL, 7, GETDATE()),
(28, NULL, NULL, NULL, 8, GETDATE()),
(29, NULL, NULL, NULL, 9, GETDATE()),
(30, NULL, NULL, NULL, 10, GETDATE());
